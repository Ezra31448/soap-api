"""
SOAP API implementation for Enhanced User Management System
"""
...
from src.utils.exceptions import format_soap_error_response
...
class UserManagementService(ServiceBase):
    ...
    async def RegisterUser(ctx, email, password, firstName, lastName, phoneNumber):
        ...
        try:
            ...
            return _format_success_response(result, "User registered successfully")
            
        except Exception as e:
            logger.error("User registration failed", error=str(e))
            return format_soap_error_response(e)
    ...
    async def AuthenticateUser(ctx, email, password):
        ...
        try:
            ...
            if result.get('success'):
                ...
                return _format_success_response(result, "Authentication successful")
            else:
                # Log failed login
                await audit_service.log_event(
                    user_id=None,
                ...
                return format_soap_error_response(Exception("Invalid credentials"))
    ...
    async def LogoutUser(ctx, token):
        ...
        try:
            ...
            if not user_info:
                return format_soap_error_response(Exception("Invalid token"))
            ...
            return _format_success_response(result, "Logout successful")
    ...
    async def GetUserProfile(ctx, token, userId=None):
        ...
        try:
            ...
            return _format_success_response(result, "Profile retrieved successfully")
    ...
    async def UpdateUserProfile(ctx, token, userId=None, firstName=None, lastName=None, phoneNumber=None, profilePictureUrl=None):
        ...
        try:
            ...
            return _format_success_response(result, "Profile updated successfully")
    ...
    async def GetAllUsers(ctx, token, page=1, pageSize=20, status=None):
        ...
        try:
            ...
            return _format_success_response(result, "Users retrieved successfully")
    ...
    async def DeactivateUser(ctx, token, userId):
        ...
        try:
            ...
            return _format_success_response(result, "User deactivated successfully")
        ...
        try:
            ...
            async with get_database_session() as session:
                ...
                if not requesting_user or not await requesting_user.has_permission(session, "ROLE_CREATE"):
                    return format_soap_error_response(Exception("Insufficient permissions"))
            ...
            return _format_success_response(result, "Role created successfully")
    ...
    async def AssignRole(ctx, token, userId, roleId):
        ...
        try:
            ...
            return _format_success_response(result, "Role assigned successfully")
    ...
    async def GetUserRoles(ctx, token, userId=None):
        ...
        try:
            ...
            # Get user roles
            result = await user_service.get_user_roles(
                requesting_user_id=user_info.get('user_id'),
                target_user_id=userId
            )
            
            return _format_success_response(result, "User roles retrieved successfully")
    ...
    async def CreatePermission(ctx, token, name, description=None, module=None, action=None):
        ...
        try:
            ...
            # Create permission
            result = await role_service.create_permission(name, description, module, action)
            ...
            return _format_success_response(result, "Permission created successfully")
    ...
    async def AssignPermissionToRole(ctx, token, roleId, permissionId):
        ...
        try:
            ...
            result = await role_service.assign_permission_to_role(
                role_id=roleId,
            ...
            return _format_success_response(result, "Permission assigned to role successfully")
    ...
    async def RequestPasswordReset(ctx, email):
        ...
        try:
            ...
            return _format_success_response(result, "Password reset email sent")
    ...
    async def ResetPassword(ctx, resetToken, newPassword):
        ...
        try:
            ...
            # Reset password
            result = await user_service.reset_password(resetToken, newPassword)
            ...
            return _format_success_response(result, "Password reset successfully")
    ...
    async def ChangePassword(ctx, token, currentPassword, newPassword):
        ...
        try:
            ...
            return _format_success_response(result, "Password changed successfully")
            
        except Exception as e:
            logger.error("Change password failed", error=str(e))
            return format_soap_error_response(e)
    
    @rpc(String, String, String, String, Integer, Integer, Integer, Integer, _returns=String)
    async def GetAuditLogs(ctx, token, startDate=None, endDate=None, userId=None, 
        ...
        try:
            ...
            return _format_success_response(result, "Audit logs retrieved successfully")
    ...
    async def GetUserAuditLogs(ctx, token, userId=None, startDate=None, 
        ...
        try:
            ...
            return _format_success_response(result, "User audit logs retrieved successfully")
            
        except Exception as e:
            logger.error("Get user audit logs failed", error=str(e))
            return format_soap_error_response(e)
    
def _format_success_response(data: Dict[str, Any], message: str) -> str:
...
def create_soap_app() -> FastAPI:
    """Create FastAPI application with proper SOAP support"""
    ...
    async def soap_endpoint(request: Request):
        """Handle SOAP requests using proper Spyne integration"""
        try:
            # Get request body
            ...
            return Response(
                content=format_soap_error_response(e),
                media_type="application/xml",
                status_code=500
            )
    ...
    async def wsdl_endpoint():
        """Serve a simple WSDL file"""
        # Return a simple WSDL for now
...
<definitions xmlns="http://schemas.xmlsoap.org/wsdl/"
  ...
  <portType name="UserManagementPortType">
    <operation name="GetStatus">
      <input message="tns:SoapResponse"/>
  ...
  <service name="UserManagementService">
    <documentation>Simple User Management SOAP Service</documentation>
